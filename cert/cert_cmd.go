...
func GenerateCert(certPATH, certEtcdPATH string, altNames []string, hostIPs []string, hostNames []string, serviceCIRD, DNSDomian string) {
	certConfig, err := NewSealosCertMetaData(certPATH, certEtcdPATH, altNames, serviceCIRD, hostNames, hostIPs, DNSDomian)
	if err != nil {
